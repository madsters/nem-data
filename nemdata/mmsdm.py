...
mmsdm_tables = [
    ...
    MMSDMTable(
        name="unit-scada",
        table="DISPATCH_UNIT_SCADA#FILE01",
        directory="DATA",
        datetime_columns=["LASTCHANGED", "SETTLEMENTDATE"],
        interval_column="SETTLEMENTDATE",
        frequency=5,
        legacy_table="DISPATCH_UNIT_SCADA",
    ),
    MMSDMTable(
        name="trading-price",
        table="TRADINGPRICE#FILE01",
        directory="DATA",
        datetime_columns=["SETTLEMENTDATE"],
        interval_column="SETTLEMENTDATE",
        ...
        legacy_table="TRADINGPRICE",
    ),
    MMSDMTable(
        name="demand",
        table="DISPATCHREGIONSUM#FILE01",
        directory="DATA",
        datetime_columns=["LASTCHANGED", "SETTLEMENTDATE"],
        interval_column="SETTLEMENTDATE",
        frequency=5,
        legacy_table="DISPATCHREGIONSUM",
    ),
    MMSDMTable(
        name="interconnectors",
        table="DISPATCHINTERCONNECTORRES#FILE01",
        directory="DATA",
        datetime_columns=["LASTCHANGED", "SETTLEMENTDATE"],
        interval_column="SETTLEMENTDATE",
        frequency=5,
        legacy_table="DISPATCHINTERCONNECTORRES",
    ),
    MMSDMTable(
        name="p5min",
    ...
    MMSDMTable(
        ...
        table="PREDISPATCHPRICESENSITIVITIES#FILE01",
        directory="DATA",
        datetime_columns=["LASTCHANGED", "DATETIME"],
        interval_column="DATETIME",
        frequency=30,
        legacy_table="PREDISPATCHPRICESENSITIVITIE_D",
    ),
    MMSDMTable(
